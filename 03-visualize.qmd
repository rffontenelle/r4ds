...
ggplot(data = millas, mapping = aes(x = cilindrada, y = autopista)) +
  geom_point() +
  geom_point(data = dplyr::filter(millas, cilindrada > 5, autopista > 20), colour = "red", size = 2.2)
```
